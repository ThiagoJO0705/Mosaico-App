...
const UserContext = createContext<UserContextType>({
  ...
  // MODIFICAÇÃO: Adicionada a função 'logout' ao valor padrão do contexto
  logout: () => {},
  syncFromFirebase: () => {},
});
...
export const UserProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const logout = () => {
    ...
    // Em um app real, aqui você limparia o AsyncStorage e o RootNavigator
    // cuidaria de redirecionar para a tela de Login.
    setUser(initialUser);
  };
