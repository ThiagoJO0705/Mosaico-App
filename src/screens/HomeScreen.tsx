...
// MODIFICAÇÃO: Importa a nova função de cálculo de XP
...
const HomeScreen: React.FC = () => {
  ...
  // MODIFICAÇÃO: Calcula o progresso do nível usando a nova lógica
  const levelInfo = calculateLevelProgress(user.xp);

  const allTracks = Array.isArray(TRACKS) ? TRACKS : [];

  // Trilhas recomendadas com base nos interesses salvos
  ...
  const weeklyMissions: MissionType[] = [
    ...
    },
    {
      ...
      rewardPieces: 2,
      rewardXp: 50,
      completed: true, // exemplo de missão concluída
    },
  ];
                ...
                <View style={styles.trackCard}>
                  <View style={styles.trackHeaderRow}>
                    <View style={styles.trackTag}>
                      <Text style={styles.trackTagText}>
                        {item.area}
                      </Text>
                    </View>
