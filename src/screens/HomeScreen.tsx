  ...
  return (
    <>
      <ScrollView style={styles.container}>
        ...
        {/* ==================== MODIFICAÇÃO: STREAK EM DESTAQUE ==================== */}
        ...
        <View style={styles.section}>
          ...
          {/* ==================== MODIFICAÇÃO: DESIGN DAS MISSÕES ==================== */}
...
const styles = StyleSheet.create({
  ...
  xpContainer: { marginBottom: 20, }, // Aumentado o espaçamento
  ...
  streakCard: {
    ...
    marginBottom: 12,
    borderWidth: 1,
    borderColor: 'rgba(255, 213, 79, 0.3)', // Borda com brilho sutil
  },
  streakIcon: {
    fontSize: 28,
  },
